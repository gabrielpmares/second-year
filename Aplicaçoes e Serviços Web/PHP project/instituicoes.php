<?php
    ...
    $query = "SELECT nome, tipo, descricao, email, passwd, telefone, concelho, freguesia, distrito, nome_cont, tel_cont
              FROM instituicao";
...
<head>
  ...
  <title>INSTITUIÇÕES - REFOOD FCUL Edition</title>
  ...
  <div class="container d-flex align-items-center">
    ...
    <nav id="navbar" class="navbar order-last order-lg-0">
      <ul>
        ...
        <li><a class="nav-link scrollto nav-active" href="instituicoes.php">Instituições</a></li>
...
<!-- End Header -->
  ...
  <section id="instit" class="instit">
    ...
    <div class="row gy-5">
        ...
        $sort_dist = sort($distritos)
        ?>
        
        <?php foreach (array_unique($distritos) as $distrito) { ?>
          <div class="section-header">
            <h2><?php echo $distrito ?></h2>
          </div>
        <?php
            $query2 = "SELECT * FROM instituicao WHERE distrito='$distrito'";
            $res2 = mysqli_query($conn, $query2);

            while($row = $res2-> fetch_assoc()){ ?>
            
              <!-- Dentro deste distrito -->
                <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                  <div class="service-item">
                    <div class="img">
                      <img id="img" src="assets/img/institutions/instituicao.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="details position-relative">
                      ...
                      <p>
                          <b>Morada: </b><?php echo $row['morada']?><br>
